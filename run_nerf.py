...
def config_parser():
    ...
    parser.add_argument("--maskdir", type=str, default='./data/airplants/mask.npy',
                        help='0-1 binary or consecutive rain mask detected manually or by detection networks')
    parser.add_argument("--measdir", type=str, default='./data/airplants/meas.npy',
                        help='cacti measurement data')
    parser.add_argument("--cr", type=int, default='8',
                        help='compressive ratio of cacti data, equal to the number of 2D binary masks') 
    ...
    # for tvloss
    parser.add_argument("--use_tv",  default=True,
                        help='option to implement total variation loss')
    parser.add_argument("--i_tvstart", type=int, default=50000,
                        help='novel view iter')
    parser.add_argument("--lamda_tv_start", type=float, default=0.005,
                        help='factor of learning rate')
    parser.add_argument("--lamda_tv_end", type=float, default=0.0005,
                        help='factor of learning rate')
    
    parser.add_argument("--n_patches", type=int, default=1,
                        help='novel view iter')
    # for raw data (bayer filter) processing
    parser.add_argument("--bayer_pattern", type=str, default='rggb',
                        help='type of bayer filter on the input raw data')
    
    # for pose initialization
    parser.add_argument("--rotation_perturb", default=False,
                        help='add additional perturbation on rotation')
    parser.add_argument("--translation_perturb", default=False,
                        help='add additional perturbation on translation')
    
    parser.add_argument("--h", type=float, default=400,
                        help='image height')
    parser.add_argument("--w", type=float, default=600,
                        help='image width')
    parser.add_argument("--f", type=float, default=720,
                        help='focal length')
